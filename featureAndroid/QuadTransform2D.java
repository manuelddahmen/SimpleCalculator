...
public class QuadTransform2D {
    ...
    public class Inter {
        ...
        public Inter(Point3D p, android.graphics.Color c) {
            this.p = p;
            this.c = c;
        }
        ...
        public android.graphics.Color getC() {
            return c;
        }

        public void setC(android.graphics.Color c) {
            this.c = c;
        }
    }
    ...
    public Inter inter(double p1243, double p1423, double t) {
        ...
        android.graphics.Color color = new Color(Lumiere.getIntFromFloats((float) (double) (cAt.get(0)),
                (float) (double) (cAt.get(1)),
                (float) (double) (cAt.get(2))));// p.toColor()
        return new Inter(pT, new one.empty3.libs.Color(color));
    }

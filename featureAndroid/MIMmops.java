...
public class MIMmops {
    public static matrix.PixM applyMultipleFilters(matrix.PixM pixM, int level, FilterPixM... filter) {
    ...
    public matrix.M matGrad(matrix.PixM image, M3 gradientX, matrix.M3 gradientY) {
        M matGrad = null;
        // image :  smoothes
     ...
     * λ1 + λ2
     */
    public void cornerStrength(matrix.M matGrad) {

...
public class FollowLines {
    private matrix.M3 traces;
    private double threshold = 0.1;
    private ArrayList<Line> lines = new ArrayList<>();
    private int maxNeighbours = 2;

    public FollowLines(matrix.M3 traces) {
        this.traces = traces;
    }

    public matrix.M3 getTraces() {
        return traces;
    }

    public void setTraces(matrix.M3 traces) {
        this.traces = traces;
    }
    ...
    public ArrayList<Line> processPoints(int ii, int ij) {
        ...
        M3 points = new matrix.M3(traces.getColumns(), traces.getLines(), 1, 1);

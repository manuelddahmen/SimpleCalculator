...
public class GradientFilter extends FilterMatPixM {
    ...
    @Override
    public M3 filter(matrix.M3 source) {
        initGNormalise();
        matrix.M3 copy = source.copy();
    ...
    public matrix.M3 norm(matrix.M3 image, matrix.M3 copy) {
    ...
    public matrix.M3 mean(matrix.M3 image, matrix.M3 copy) {

...
public class RegionLineCorner extends ProcessFile {
    ...
    private one.empty3.matrix.PixM m = null;
    private double[] max;
    private double[] min;
    ...
    public void setM(one.empty3.matrix.PixM m2) {
        this.m = m2;
    }
    ...
    public one.empty3.matrix.PixM reconstruct(List<List<Circle>> circle) {
        one.empty3.matrix.PixM rec = m.copy();
        return rec;
    }

...
public class DirectMaskFilter {
    one.empty3.matrix.PixM m1;
    one.empty3.matrix.PixM m2;
...
, p2x, p2y,c1r,c2g b a, w, h, ww, wh */
    public one.empty3.matrix.PixM applyOperator(String[] formulaColorComps) {
        one.empty3.matrix.PixM m3 = new PixM(m1.getColumns(), m1.getLines());

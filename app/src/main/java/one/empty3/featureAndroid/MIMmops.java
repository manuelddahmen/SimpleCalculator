...
public class MIMmops {
    public static one.empty3.matrix.PixM applyMultipleFilters(one.empty3.matrix.PixM pixM, int level, FilterPixM... filter) {
    ...
    public one.empty3.matrix.M matGrad(one.empty3.matrix.PixM image, M3 gradientX, one.empty3.matrix.M3 gradientY) {
        M matGrad = null;
        // image :  smoothes
     ...
     * λ1 + λ2
     */
    public void cornerStrength(one.empty3.matrix.M matGrad) {

    ...
    public boolean process(File in, File out) {
        ...
        try {
            ...
            Linear linear = new Linear(imagesMatrix[0][0], imagesMatrix[0][1],
                    new one.empty3.matrix.PixM(imagesMatrix[0][0].getColumns(), imagesMatrix[0][0].getLines()));

            boolean b = linear.op2d2d(new char[]{'*'}, new int[][]{{0}, {1}}, new int[]{2});

            one.empty3.matrix.PixM image = linear.getImages()[2];

 ...
 * @author Manuel
 */
package one.empty3.libraryAndroid;
...
import one.empty3.featureAndroid.GoogleFaceDetection;
...
public class Polygon1 extends Representable implements SurfaceElem, ClosedCurve, Parcelable {
    ...
    public static final Parcelable.Creator<Polygon1> CREATOR = new Parcelable.Creator<Polygon1>() {
        @Override
    ...
    public boolean leftToRightScanPixM(one.empty3.matrix.PixM pixM, int x, int y, boolean[] columnLeft, boolean[] columnRight) {
    ...
    public boolean leftToRightScanPixM(one.empty3.matrix.PixM pixM, int x, int y, boolean isDrawingOnImage) {
    ...
    public PixM fillPolygon2D(GoogleFaceDetection.FaceData.Surface faceSurface, Canvas canvas, Bitmap bitmap, int transparent, double deep, PointF position, double scale) {
        ...
        one.empty3.matrix.PixM pixM = new one.empty3.matrix.PixM((int) (widthBox), (int) (heightBox));
    ...
    public void fillPolygon2DFromData(GoogleFaceDetection.FaceData.Surface surface, Bitmap mCopy, int black) {
        ...
        one.empty3.matrix.PixM pixM = surface.getFilledContours();
